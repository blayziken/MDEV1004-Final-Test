...
router.get('/', (req, res, next) => { (0, songs_1.DisplaySongsList)(req, res, next); });
router.get('/list', (req, res, next) => { (0, songs_1.DisplaySongsList)(req, res, next); });
router.get('/find/:id', (req, res, next) => { (0, songs_1.DisplaySongById)(req, res, next); });
router.post('/add', passport_1.default.authenticate('jwt', { session: false }), (req, res, next) => { (0, songs_1.AddSong)(req, res, next); });
